...
"""PyInstaller spec for LocalTranscribe."""
import os
...
app = BUNDLE(
    coll,
    name="LocalTranscribe.app",
    icon=None,
    bundle_identifier="com.rdobson.local-transcribe",
    info_plist={
        "CFBundleName": "LocalTranscribe",
        "CFBundleDisplayName": "LocalTranscribe",
